...
export const timelineEvents: TimelineEvent[] = [
  // 远古时期
  {
    ...
    dynasty: '远古',
    category: '文化',
    summary: '黄河中游地区代表性文化，以彩陶文化著称，代表性遗址：半坡遗址。出现了原始农业和畜牧业',
    impact: '奠定了中华农业文明的基础',
    importance: 3,
  },
  {
    ...
    dynasty: '远古',
    category: '文化',
    summary: '黄河下游地区代表性文化，出现了私有制和贫富分化，父系氏族社会时期',
    impact: '体现了社会分化的早期迹象',
    importance: 3,
  },
  {
    ...
    dynasty: '远古',
    category: '文化',
    summary: '黄河中下游地区，代表性黑陶文化，社会分工扩大，军事民主制时期，传说中尧舜禹禅让',
    impact: '为夏朝建立奠定基础',
    importance: 4,
  },
  {
    ...
    dynasty: '远古',
    category: '文化',
    summary: '长江下游地区，代表性玉器文化，出现了大规模水利工程和城市规划',
  ...
  },
  {
    ...
    dynasty: '远古',
    category: '文化',
    summary: '东北地区，代表性玉器和祭祀遗址，反映了早期宗教信仰',
    importance: 3,
  },
  ...
  },
  {
    ...
    dynasty: '商朝',
    category: '文化',
    summary: '商朝以青铜器铸造著称，甲骨文成熟，反映了高度发达的奴隶制文明',
  ...
  },
  {
    ...
    dynasty: '西周',
    category: '政治',
    summary: '周武王灭商，建立西周，实行分封制、宗法制、礼乐制',
  ...
  },
  {
    ...
    dynasty: '西周',
    category: '政治',
    summary: '周天子将土地和人民分封给王族、功臣、先代贵族，建立藩屏周室的统治秩序',
    impact: '加强了周天子对地方的控制，扩大了统治区域，但后来导致诸侯割据',
    importance: 5,
    keyPeople: ['周武王', '周公'],
  },
  {
    ...
    dynasty: '西周',
    category: '政治',
    summary: '按照父系血缘关系亲疏分配政治权力，以嫡长子继承制为核心，解决贵族权力继承矛盾',
  ...
  },
  {
    ...
    dynasty: '西周',
    category: '思想',
    summary: '维护宗法制和分封制的行为规范和准则，用音乐协调等级秩序',
  ...
  },
  {
    ...
    dynasty: '西周',
    category: '经济',
    summary: '奴隶主土地国有制，土地分为公田和私田，劳动者无土地使用权',
  ...
  },
  {
    ...
    dynasty: '春秋',
    category: '政治',
    summary: '周王室权威衰落，诸侯争霸，分封制、宗法制遭到破坏',
  ...
  },
  {
    ...
    dynasty: '战国',
    category: '经济',
    summary: '井田制逐渐瓦解，土地可以买卖，封建土地私有制确立',
    impact: '确立了小农经济的生产方式',
    importance: 4,
  },
  {
    ...
    dynasty: '战国·秦',
    category: '政治',
    summary: '在秦国推行一系列改革：重农抑商、奖励军功、废井田开阡陌、推行县制、什伍连坐',
  ...
  },
  {
    ...
    dynasty: '春秋战国',
    category: '思想',
    summary: '私学兴起，士阶层崛起，儒、道、墨、法、名、阴阳等学派林立',
    impact: '奠定了中国传统文化体系的基础，是中国历史上第一次思想解放运动',
    importance: 5,
    keyPeople: ['孔子', '老子', '孟子', '荀子', '墨子', '韩非子', '商鞅'],
  },
  {
    ...
    dynasty: '春秋',
    category: '思想',
    summary: '提出"仁"和"礼"的核心思想，主张"有教无类"，重视伦理道德',
  ...
  },
  {
    ...
    dynasty: '春秋',
    category: '思想',
    summary: '提出"道法自然"，主张无为而治，朴素的辩证法思想',
    importance: 4,
    keyPeople: ['老子'],
  },
  {
    id: 'hundred_schools_battle',
    year: '战国',
    title: '战国百家争鸣高潮',
    dynasty: '战国',
    category: '思想',
    summary: '孟子发展儒家"仁政"思想；荀子提出"性恶论"；韩非子集法家之大成；墨子提倡"兼爱""非攻"',
    impact: '为新兴地主阶级登上历史舞台提供思想理论基础',
    importance: 4,
    keyPeople: ['孟子', '荀子', '韩非子', '墨子'],
  },
  {
    id: 'qin_unification',
    year: '前221年',
    ...
    dynasty: '秦朝',
    category: '政治',
    summary: '秦始皇灭六国，建立中国历史上第一个大一统封建王朝',
    impact: '建立起幅员辽阔的国家，奠定了此后历代疆域的基本版图',
    importance: 5,
    keyPeople: ['秦始皇'],
  },
  {
  ...
  },
  {
    ...
    dynasty: '秦朝',
    category: '政治',
    summary: '丞相（百官之首）、御史大夫（监察）、太尉（军事）三公，下设九卿',
    impact: '建立了中央官制体系',
    importance: 4,
  },
  {
    ...
    dynasty: '秦朝',
    category: '政治',
    summary: '废除分封制，在全境推行郡县制，郡守和县令由中央任免',
    impact: '实现了中央对地方的直接有效控制，由官僚政治取代贵族政治',
    importance: 5,
  },
  {
    ...
    dynasty: '秦朝',
    category: '政治',
    summary: '统一度量衡、货币、文字；修筑长城；修驰道直道；颁行法律',
  ...
  },
  {
    ...
    dynasty: '战国',
    category: '经济',
    summary: '铁犁牛耕背景下，以家庭为单位、分散经营的小农经济开始形成',
    impact: '成为中国封建社会统治的经济基础，延续两千多年',
    importance: 5,
  },
  {
    id: 'huaxia_identity',
    ...
    dynasty: '春秋',
    category: '社会',
    summary: '华夷五方观念形成，诸侯通过"尊王攘夷"战争扩大华夏族影响力',
    impact: '促进了民族交融，为统一多民族国家奠定基础',
    importance: 4,
  },
  {
    id: 'private_economy',
  ...
  },
  {
    ...
    dynasty: '西汉',
    category: '政治',
    summary: '推恩令、罢黜百家独尊儒术、盐铁官营、加强中央集权',
    impact: '巩固了西汉大一统局面，奠定了中国儒学正统地位',
    importance: 5,
    keyPeople: ['汉武帝'],
  },
  {
  ...
  },
  {
    ...
    dynasty: '西汉-东汉',
    category: '文化',
    summary: '儒学独尊、经学兴盛、史学成就、科技发明（造纸术）、丝织业发展',
    impact: '奠定了中华文化的基本格局',
    importance: 4,
  },
];
