...
export const chinaProvincesData: Record<string, ChinaProvinceData> = {
  ...
  '安徽': {
    ...
    humidityZone: '湿润区',
    terrain: '南北差异显著',
    features: ['皖南山区', '皖中丘陵', '皖北平原'],
    resources: ['矿产资源', '农产品资源'],
    economy: '中部崛起战略，制造业转移承接地',
    gaokaoPoints: ['南北过渡带特征', '皖江城市带'],
    rivers: ['淮河', '长江', '新安江'],
    mountains: ['黄山', '大别山'],
  },
  '福建': {
    ...
    humidityZone: '湿润区',
    terrain: '背山面海',
    features: ['武夷山脉', '闽中戴云山脉', '沿海平原'],
    resources: ['森林资源', '海洋资源', '旅游资源'],
    economy: '外向型经济，鞋服产业',
    gaokaoPoints: ['海西经济区', '侨乡优势', '山海协作'],
    rivers: ['闽江', '九龙江', '晋江'],
    mountains: ['武夷山', '戴云山'],
  },
  '江西': {
    ...
    humidityZone: '湿润区',
    terrain: '三面环山，中部丘陵起伏',
    features: ['赣北鄱阳湖平原', '赣中丘陵', '赣南山区'],
    resources: ['有色金属（赣州）', '鄱阳湖湿地', '森林资源'],
    economy: '生态经济，红色旅游',
    gaokaoPoints: ['鄱阳湖湿地保护', '赣南脐橙', '有色金属基地'],
    rivers: ['赣江', '抚河', '信江', '饶河'],
    mountains: ['庐山', '井冈山', '武夷山', '南岭'],
  },
  '湖南': {
    name: '湖南省',
    shortName: '湘',
    ...
    temperatureZone: '亚热带',
    humidityZone: '湿润区',
    terrain: '东、西、南三面环山，中部丘陵起伏，北部洞庭湖平原',
    features: ['湘西山区', '湘中丘陵', '湘北洞庭湖平原'],
    resources: ['有色金属', '洞庭湖湿地', '森林资源'],
    economy: '工程机械，文化旅游',
    gaokaoPoints: ['湘江流域治理', '环洞庭湖经济圈', '长株潭城市群'],
    rivers: ['湘江', '沅江', '资江', '澧水'],
    mountains: ['衡山', '张家界', '雪峰山', '武陵山'],
  },
  '湖北': {
    name: '湖北省',
    shortName: '鄂',
    ...
    terrain: '西高东低',
    features: ['鄂西山地', '江汉平原'],
    resources: ['水资源', '磷矿', '汉江平原'],
    economy: '汽车产业，光电子信息',
    gaokaoPoints: ['武汉城市圈', '长江经济带', '三峡工程'],
    rivers: ['长江', '汉江', '清江'],
    mountains: ['武当山', '神农架', '大别山'],
  },
  '海南': {
    name: '海南省',
    shortName: '琼',
    ...
    terrain: '中间高，四周低',
    features: ['五指山', '沿海平原'],
    resources: ['热带作物', '海洋资源', '旅游资源'],
    economy: '国际旅游岛',
    gaokaoPoints: ['热带高效农业', '海洋经济', '国际旅游岛建设'],
    rivers: ['南渡江', '万泉河', '昌化江'],
    mountains: ['五指山', '霸王岭'],
  },
  '重庆': {
    ...
    temperatureZone: '亚热带',
    humidityZone: '湿润区',
    terrain: '山区为主，大巴山、巫山、武陵山',
    features: ['川东平行岭谷', '重庆主城', '渝东南山区'],
    resources: ['天然气', '旅游资源'],
    economy: '汽车摩托车，IT产业',
    gaokaoPoints: ['山城特色', '三峡库区发展', '成渝双城经济圈'],
    rivers: ['长江', '嘉陵江', '乌江'],
    mountains: ['大巴山', '巫山', '武陵山'],
  },
  '贵州': {
    name: '贵州省',
    shortName: '黔',
    ...
    temperatureZone: '亚热带',
    humidityZone: '湿润区',
    terrain: '西高东低，喀斯特地貌典型',
    features: ['黔北高原', '黔中丘陵', '黔南山地'],
    resources: ['煤炭', '水能', '磷矿', '旅游资源'],
    economy: '大数据产业，旅游产业',
    gaokaoPoints: ['喀斯特地貌与生态保护', '大数据中心建设', '天眼工程'],
    rivers: ['乌江', '赤水河', '南盘江', '北盘江'],
    mountains: ['梵净山', '乌蒙山', '大娄山'],
  },
  '云南': {
    name: '云南省',
    shortName: '滇',
    capital: '昆明',
    temperatureZone: '亚热带/高原气候',
    humidityZone: '湿润区/半湿润区',
    terrain: '西北高、东南低，地势起伏大',
    features: ['滇池坝子', '横断山区', '坝子农业'],
    resources: ['有色金属', '生物多样性', '水电资源'],
    economy: '旅游产业，有色金属',
    gaokaoPoints: ['垂直地带性规律', '横断山区特色', '生物多样性保护'],
    rivers: ['金沙江', '澜沧江', '怒江', '红河'],
    mountains: ['梅里雪山', '玉龙雪山', '高黎贡山'],
  },
  '西藏': {
    name: '西藏自治区',
    shortName: '藏',
    capital: '拉萨',
    temperatureZone: '高原气候',
    humidityZone: '干旱区/半湿润区',
    terrain: '世界屋脊，平均海拔4000米以上',
    features: ['青藏高原主体', '喜马拉雅山脉', '藏北高原'],
    resources: ['太阳能', '地热能', '冰川资源', '矿产资源'],
    economy: '旅游业，特色农牧业',
    gaokaoPoints: ['高寒气候特征', '冰川与湖泊保护', '藏羚羊保护'],
    rivers: ['雅鲁藏布江', '怒江', '澜沧江', '金沙江'],
    mountains: ['珠穆朗玛峰', '冈仁波齐', '念青唐古拉山'],
  },
  '甘肃': {
    name: '甘肃省',
    shortName: '甘/陇',
    capital: '兰州',
    temperatureZone: '暖温带/中温带',
    humidityZone: '干旱区/半干旱区',
    terrain: '狭长型，地形复杂',
    features: ['陇南山地', '黄土高原', '河西走廊', '甘南高原'],
    resources: ['镍矿（金昌）', '有色金属', '风能光能'],
    economy: '有色冶金，特色农业',
    gaokaoPoints: ['河西走廊绿洲农业', '丝绸之路经济带', '新能源基地'],
    rivers: ['黄河', '洮河', '黑河', '疏勒河'],
    mountains: ['祁连山', '乌鞘岭', '岷山', '阿尔金山'],
  },
  '青海': {
    name: '青海省',
    shortName: '青',
    ...
    humidityZone: '干旱区/半干旱区',
    terrain: '青藏高原东北部',
    features: ['柴达木盆地', '青海湖盆地', '青南高原'],
    resources: ['盐湖资源（察尔汗）', '水能', '石油', '草地资源'],
    economy: '盐湖化工，生态旅游',
    gaokaoPoints: ['三江源保护', '盐湖资源开发', '可可西里保护'],
    rivers: ['长江', '黄河', '澜沧江', '内流河'],
    mountains: ['昆仑山', '巴颜喀拉山', '阿尼玛卿山', '唐古拉山（东段）'],
  },
  '宁夏': {
    name: '宁夏回族自治区',
    shortName: '宁',
    ...
    terrain: '黄土高原，黄河灌区',
    features: ['宁夏平原', '六盘山区'],
    resources: ['煤炭', '土地资源', '光伏资源'],
    economy: '能源化工，清真产业',
    gaokaoPoints: ['黄河灌溉农业', '西海固生态移民', '防沙治沙'],
    rivers: ['黄河'],
    mountains: ['贺兰山', '六盘山'],
  },
  '新疆': {
    ...
    shortName: '新',
    capital: '乌鲁木齐',
    temperatureZone: '温带/暖温带',
    humidityZone: '干旱区',
    terrain: '三山夹两盆',
    features: ['塔里木盆地', '准噶尔盆地', '吐鲁番盆地'],
    resources: ['石油', '天然气', '煤炭', '棉花', '瓜果'],
    economy: '能源工业，农业',
    gaokaoPoints: ['绿洲农业', '西气东输', '棉花产业', '人口迁移'],
    rivers: ['塔里木河', '伊犁河', '额尔齐斯河'],
    mountains: ['天山', '阿尔泰山', '昆仑山'],
  },
  '广西': {
    name: '广西壮族自治区',
    shortName: '桂',
    ...
    humidityZone: '湿润区',
    terrain: '山地丘陵为主',
    features: ['桂西岩溶高原', '桂中丘陵', '桂南沿海平原'],
    resources: ['有色金属', '水能', '海洋资源', '旅游资源'],
    economy: '有色金属，旅游',
    gaokaoPoints: ['北部湾经济区', '珠江-西江经济带', '喀斯特地貌旅游'],
    rivers: ['西江', '左江', '右江', '红水河'],
    mountains: ['桂林山水', '十万大山', '大明山'],
  },
  '香港': {
    name: '香港特别行政区',
    shortName: '港',
    ...
    humidityZone: '湿润区',
    terrain: '丘陵为主，平地少',
    features: ['香港岛', '九龙半岛', '新界'],
    resources: ['深水港', '人力资源'],
    economy: '国际金融中心，转口贸易',
    gaokaoPoints: ['自由港优势', '珠三角合作'],
  },
  '澳门': {
    name: '澳门特别行政区',
    shortName: '澳',
    ...
    resources: ['博彩业', '旅游资源'],
    economy: '博彩旅游',
    gaokaoPoints: ['一国两制实践', '旅游博彩业'],
  },
  '台湾': {
    name: '台湾省',
    shortName: '台',
    capital: '台北',
    temperatureZone: '亚热带/热带',
    humidityZone: '湿润区',
    terrain: '中间高、四周低',
    features: ['台湾山脉', '西部平原', '东部海岸山脉'],
    resources: ['森林资源', '渔业资源', '高山农业'],
    economy: '电子产业，半导体',
    gaokaoPoints: ['外向型经济', '电子产业', '阿里山生态'],
    rivers: ['浊水溪', '高屏溪', '淡水河'],
    mountains: ['玉山', '阿里山', '中央山脉', '雪山'],
  },
};
