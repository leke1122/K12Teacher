  ...
  useEffect(() => {
    ...
    import('echarts').then((echarts) => {
      ...
      const colors: Record<string, string> = {
        // 东北地区 - 各自独立颜色
        '辽宁': '#4169E1', '吉林': '#6495ED', '黑龙江': '#87CEEB',
        // 华北地区 - 不同色调
        '北京': '#CD853F', '天津': '#DEB887', '河北': '#F5DEB3',
        '山西': '#D2B48C', '内蒙古': '#BDB76B',
        // 华东地区 - 各自独立
        '山东': '#8FBC8F', '江苏': '#98FB98', '安徽': '#90EE90',
        '浙江': '#00FA9A', '福建': '#00CED1', '江西': '#20B2AA',
        '上海': '#7FFFD4',
        // 华中地区 - 不同色调
        '河南': '#F0E68C', '湖北': '#9ACD32', '湖南': '#6B8E23',
        // 华南地区 - 各自独立
        '广东': '#FF6347', '广西': '#FF7F50', '海南': '#FFA07A',
        '香港': '#FF69B4', '澳门': '#FFB6C1', '台湾': '#FF4500',
        // 西南地区 - 不同色调
        '重庆': '#228B22', '四川': '#32CD32', '贵州': '#9ACD32',
        '云南': '#3CB371', '西藏': '#6B8E23',
        // 西北地区 - 不同色调
        '陕西': '#DAA520', '甘肃': '#B8860B', '青海': '#D2691E',
        '宁夏': '#F4A460', '新疆': '#CD853F',
      };

      // 省份区域名称映射（短名 -> GeoJSON全称）
